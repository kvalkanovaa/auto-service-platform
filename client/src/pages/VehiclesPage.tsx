...
export default function VehiclesPage() {
  ...
  const [added, setAdded] = useState<string | null>(
    () => (location.state as { added?: string } | null)?.added ?? null,
  );
  ...
  return (
    <Layout>
      {added && (
        <SuccessBanner
          text={`Автомобилът „${added}“ е добавен успешно и вече е в списъка.`}
      ...
      <div className={styles['header']}>
        <div>
          ...
          <p className={styles['header__subtitle']}>
            Управлявай регистрираните си автомобили
          </p>
        </div>
      ...
      <InfoBanner
        ...
        steps={[
          'Добави автомобил',
          'Опиши проблем или запази час',
          'Следи сервизната история',
        ]}
      />
      ...
      {isLoading ? (
        ...
        <div className={styles['empty']}>
          ...
          <p className={styles['empty__text']}>
            Добави първата си кола, за да можеш да описваш проблеми и да
            запазваш часове
          </p>
          ...
          {vehicles.map((v) => (
            ...
            >
              <div className={styles['card']}>
                {/* Image */}
                <div
                  className={`${styles['card__image-wrap']} ${v.imageUrl ? styles['card__image-wrap--photo'] : styles['card__image-wrap--placeholder']}`}
                >
                  {v.imageUrl ? (
                    <img
                      src={v.imageUrl}
                ...
                <div className={styles['card__content']}>
                  ...
                  <div className={styles['card__tags']}>
                    <span
                      className={`${styles['card__tag']} ${styles['card__tag--fuel']}`}
                    >
                      {fuelLabels[v.fuelType]}
                    </span>
                    <span
                      className={`${styles['card__tag']} ${styles['card__tag--transmission']}`}
                    >
                      {transmissionLabels[v.transmission]}
                    </span>
                    {v.engine && (
                      <span
                        className={`${styles['card__tag']} ${styles['card__tag--engine']}`}
                      >
                    ...
                    {v.mileage != null && (
                      <span
                        className={`${styles['card__tag']} ${styles['card__tag--mileage']}`}
                      >
