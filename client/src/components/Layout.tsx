        ...
        <div className={styles['header__inner']}>
          <div className={styles['header__left']}>
            <Link
              ...
              onClick={closeMenu}
            >
              <Logo size={38} gid="lgHeader" />
              <span className={styles['logo__text']}>
                Diagn<span style={{ color: '#f97316' }}>aut</span>
              </span>
            </Link>
      ...
      <footer className={styles['footer']}>
        <div className={styles['footer__inner']}>
          <div className={styles['footer__brand']}>
            <Logo size={32} gid="lgFooter" />
            <div>
              <p className={styles['footer__brand-name']}>
                Diagn<span style={{ color: '#f97316' }}>aut</span> Platform
              </p>
          ...
          <nav className={styles['footer__nav']}>
            <Link to="/service-centers" className={styles['footer__nav-link']}>
              Сервизи
            </Link>
            ...
            <Link
              to="/become-partner"
              className={`${styles['footer__nav-link']} ${styles['footer__nav-link--cta']}`}
            >
              Регистрирай сервиз
            </Link>
          </nav>
            ...
            >
              ...
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M2.5 5.5C2.5 4 3.5 3 5 3h2l1.5 4-2 1.5a13 13 0 0 0 6 6l1.5-2 4 1.5v2c0 1.5-1 2.5-2.5 2.5A16.5 16.5 0 0 1 2.5 5.5z"
                />
              </svg>
              +359 2 123 4567
            </a>
            <span className={styles['footer__contact-link']}>
              <svg
                width="15"
                height="15"
                viewBox="0 0 24 24"
